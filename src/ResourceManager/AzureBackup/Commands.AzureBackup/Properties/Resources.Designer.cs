...
namespace Microsoft.Azure.Commands.AzureBackup.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to This operation will delete all data in the backup vault that is associated with the virtual machine. Are you sure you want to unregister the container?.
        /// </summary>
        internal static string UnregisterContainerMessage {
            get {
                return ResourceManager.GetString("UnregisterContainerMessage", resourceCulture);
            }
        }
