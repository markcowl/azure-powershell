namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListResult))]
    public class GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_ResourceGroupSubscriptionIdRegistriesListByResourceGroup(Carbon.Json.JsonObject json)
        {
