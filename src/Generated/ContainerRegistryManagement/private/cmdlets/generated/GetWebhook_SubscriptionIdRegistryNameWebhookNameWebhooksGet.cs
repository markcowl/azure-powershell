namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksGet(Carbon.Json.JsonObject json)
        {
