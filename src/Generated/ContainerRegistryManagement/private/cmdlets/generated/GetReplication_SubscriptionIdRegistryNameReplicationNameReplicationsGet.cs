namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_SubscriptionIdRegistryNameReplicationNameReplicationsGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_SubscriptionIdRegistryNameReplicationNameReplicationsGet(Carbon.Json.JsonObject json)
        {
