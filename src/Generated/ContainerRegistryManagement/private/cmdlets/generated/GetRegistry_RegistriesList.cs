namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_RegistriesList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListResult))]
    public class GetRegistry_RegistriesList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_RegistriesList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_RegistriesList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_RegistriesList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_RegistriesList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_RegistriesList()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_RegistriesList(Carbon.Json.JsonObject json)
        {
