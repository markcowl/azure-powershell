namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Replication_RegistryNameReplicationNameTagsReplicationsUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateReplication_RegistryNameReplicationNameTagsReplicationsUpdate(Carbon.Json.JsonObject json)
        {
