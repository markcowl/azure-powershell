namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Webhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete")]
    public class RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksDelete(Carbon.Json.JsonObject json)
        {
