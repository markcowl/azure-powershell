namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhookListResult))]
    public class GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhooksList(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.WebhooksList(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IWebhookListResult
