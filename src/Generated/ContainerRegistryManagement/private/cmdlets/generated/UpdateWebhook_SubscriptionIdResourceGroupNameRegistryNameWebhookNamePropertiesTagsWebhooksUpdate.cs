namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Webhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for WebhookUpdateParameters property</summary>
        private Sample.API.Models.IWebhookUpdateParameters _webhookUpdateParameters;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters for updating a webhook.")]
        public Sample.API.Models.IWebhookUpdateParameters WebhookUpdateParameters
        {
            get
            {
                return this._webhookUpdateParameters;
            }
            set
            {
                this._webhookUpdateParameters = value;
            }
        }
        protected override void BeginProcessing()
        {
        }
        public Sample.API.Cmdlets.UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.WebhooksUpdate(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, WebhookName, WebhookUpdateParameters, async(response) => {
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "WebhookUpdateParameters", WebhookUpdateParameters?.ToJson());
            return result;
        }
        public UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate(Carbon.Json.JsonObject json)
        {
            ...
            _webhookUpdateParameters = Sample.API.Models.WebhookUpdateParameters.FromJson(json.Property("WebhookUpdateParameters"));
        }
    }
}