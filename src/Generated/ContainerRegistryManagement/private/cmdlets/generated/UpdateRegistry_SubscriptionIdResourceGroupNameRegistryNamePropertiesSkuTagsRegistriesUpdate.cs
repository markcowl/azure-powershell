namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Registry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for RegistryUpdateParameters property</summary>
        private Sample.API.Models.IRegistryUpdateParameters _registryUpdateParameters;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters for updating a container registry.")]
        public Sample.API.Models.IRegistryUpdateParameters RegistryUpdateParameters
        {
            get
            {
                return this._registryUpdateParameters;
            }
            set
            {
                this._registryUpdateParameters = value;
            }
        }
        ...
        public Sample.API.Cmdlets.UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesUpdate(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, RegistryUpdateParameters, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IRegistry
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "RegistryUpdateParameters", RegistryUpdateParameters?.ToJson());
            return result;
        }
        public UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateRegistry_SubscriptionIdResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate(Carbon.Json.JsonObject json)
        {
            ...
            _registryUpdateParameters = Sample.API.Models.RegistryUpdateParameters.FromJson(json.Property("RegistryUpdateParameters"));
        }
    }
}