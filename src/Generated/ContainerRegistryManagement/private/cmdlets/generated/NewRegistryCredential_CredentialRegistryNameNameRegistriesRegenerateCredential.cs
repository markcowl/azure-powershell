namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"RegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistryCredential_CredentialRegistryNameNameRegistriesRegenerateCredential(Carbon.Json.JsonObject json)
        {
