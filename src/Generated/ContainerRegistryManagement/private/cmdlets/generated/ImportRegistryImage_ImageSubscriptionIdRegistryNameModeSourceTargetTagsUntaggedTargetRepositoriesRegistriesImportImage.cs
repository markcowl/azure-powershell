namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"RegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage")]
    public class ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage Clone()
        {
        ...
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage()
        {
        }
        /// <param name="json"> </param>
        internal ImportRegistryImage_ImageSubscriptionIdRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(Carbon.Json.JsonObject json)
        {
