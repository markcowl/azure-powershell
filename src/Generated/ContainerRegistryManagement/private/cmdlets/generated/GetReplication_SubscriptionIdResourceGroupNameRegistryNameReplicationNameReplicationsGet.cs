namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsGet(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.ReplicationsGet(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, ReplicationName, async(response) => {
