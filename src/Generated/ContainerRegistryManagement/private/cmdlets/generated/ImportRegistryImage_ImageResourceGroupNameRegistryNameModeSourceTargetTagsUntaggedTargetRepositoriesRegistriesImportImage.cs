namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"RegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage")]
    public class ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage Clone()
        {
        ...
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage()
        {
        }
        /// <param name="json"> </param>
        internal ImportRegistryImage_ImageResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(Carbon.Json.JsonObject json)
        {
