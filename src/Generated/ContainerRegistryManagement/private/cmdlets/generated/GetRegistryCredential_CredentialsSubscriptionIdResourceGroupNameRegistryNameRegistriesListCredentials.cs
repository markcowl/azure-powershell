namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"RegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistryCredential_CredentialsSubscriptionIdResourceGroupNameRegistryNameRegistriesListCredentials(Carbon.Json.JsonObject json)
        {
