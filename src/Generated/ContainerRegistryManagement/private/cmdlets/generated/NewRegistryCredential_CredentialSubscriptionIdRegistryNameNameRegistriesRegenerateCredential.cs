namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"RegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistryCredential_CredentialSubscriptionIdRegistryNameNameRegistriesRegenerateCredential(Carbon.Json.JsonObject json)
        {
