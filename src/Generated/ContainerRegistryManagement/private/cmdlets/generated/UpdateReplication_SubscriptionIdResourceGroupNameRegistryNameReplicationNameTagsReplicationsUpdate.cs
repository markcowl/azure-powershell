namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Replication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for ReplicationUpdateParameters property</summary>
        private Sample.API.Models.IReplicationUpdateParameters _replicationUpdateParameters;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters for updating a replication.")]
        public Sample.API.Models.IReplicationUpdateParameters ReplicationUpdateParameters
        {
            get
            {
                return this._replicationUpdateParameters;
            }
            set
            {
                this._replicationUpdateParameters = value;
            }
        }
        ...
        public Sample.API.Cmdlets.UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.ReplicationsUpdate(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, ReplicationName, ReplicationUpdateParameters, async(response) => {
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "ReplicationUpdateParameters", ReplicationUpdateParameters?.ToJson());
            return result;
        }
        public UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate(Carbon.Json.JsonObject json)
        {
            ...
            _replicationUpdateParameters = Sample.API.Models.ReplicationUpdateParameters.FromJson(json.Property("ReplicationUpdateParameters"));
        }
    }
}