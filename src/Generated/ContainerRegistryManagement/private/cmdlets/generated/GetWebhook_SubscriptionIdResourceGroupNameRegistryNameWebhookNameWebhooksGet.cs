namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGet(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.WebhooksGet(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, WebhookName, async(response) => {
