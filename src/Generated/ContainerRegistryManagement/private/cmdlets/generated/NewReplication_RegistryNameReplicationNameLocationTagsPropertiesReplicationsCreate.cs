namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Replication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewReplication_RegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate(Carbon.Json.JsonObject json)
        {
