namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_SubscriptionIdRegistriesList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListResult))]
    public class GetRegistry_SubscriptionIdRegistriesList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_SubscriptionIdRegistriesList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_SubscriptionIdRegistriesList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_SubscriptionIdRegistriesList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_SubscriptionIdRegistriesList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_SubscriptionIdRegistriesList()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_SubscriptionIdRegistriesList(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesList(ApiVersion, SubscriptionId, async(response) => {
