namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Replication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete")]
    public class RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveReplication_SubscriptionIdRegistryNameReplicationNameReplicationsDelete(Carbon.Json.JsonObject json)
        {
