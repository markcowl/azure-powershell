namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_SubscriptionIdRegistryNameWebhooksList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhookListResult))]
    public class GetWebhook_SubscriptionIdRegistryNameWebhooksList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_SubscriptionIdRegistryNameWebhooksList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdRegistryNameWebhooksList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_SubscriptionIdRegistryNameWebhooksList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_SubscriptionIdRegistryNameWebhooksList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_SubscriptionIdRegistryNameWebhooksList()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_SubscriptionIdRegistryNameWebhooksList(Carbon.Json.JsonObject json)
        {
