namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"RegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for RegenerateCredentialParameters property</summary>
        private Sample.API.Models.IRegenerateCredentialParameters _regenerateCredentialParameters;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters used to regenerate the login credential.")]
        public Sample.API.Models.IRegenerateCredentialParameters RegenerateCredentialParameters
        {
            get
            {
                return this._regenerateCredentialParameters;
            }
            set
            {
                this._regenerateCredentialParameters = value;
            }
        }
        ...
        public Sample.API.Cmdlets.NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistryCredential_CredentialSubscriptionIdResourceGroupNameRegistryNameNameRegistriesRegenerateCredential(Carbon.Json.JsonObject json)
        {
            ...
            _regenerateCredentialParameters = Sample.API.Models.RegenerateCredentialParameters.FromJson(json.Property("RegenerateCredentialParameters"));
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesRegenerateCredential(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, RegenerateCredentialParameters, async(response) => {
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "RegenerateCredentialParameters", RegenerateCredentialParameters?.ToJson());
            return result;
        }
    }
}