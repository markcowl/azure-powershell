namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ICallbackConfig))]
    public class GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookCallbackConfig_CallbackConfigResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig(Carbon.Json.JsonObject json)
        {
