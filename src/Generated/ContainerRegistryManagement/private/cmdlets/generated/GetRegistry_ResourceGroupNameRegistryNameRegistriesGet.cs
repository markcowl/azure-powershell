namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_ResourceGroupNameRegistryNameRegistriesGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class GetRegistry_ResourceGroupNameRegistryNameRegistriesGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_ResourceGroupNameRegistryNameRegistriesGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupNameRegistryNameRegistriesGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_ResourceGroupNameRegistryNameRegistriesGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupNameRegistryNameRegistriesGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_ResourceGroupNameRegistryNameRegistriesGet()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_ResourceGroupNameRegistryNameRegistriesGet(Carbon.Json.JsonObject json)
        {
