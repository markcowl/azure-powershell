namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_RegistryNameRegistriesGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class GetRegistry_RegistryNameRegistriesGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_RegistryNameRegistriesGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_RegistryNameRegistriesGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_RegistryNameRegistriesGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_RegistryNameRegistriesGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_RegistryNameRegistriesGet()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_RegistryNameRegistriesGet(Carbon.Json.JsonObject json)
        {
