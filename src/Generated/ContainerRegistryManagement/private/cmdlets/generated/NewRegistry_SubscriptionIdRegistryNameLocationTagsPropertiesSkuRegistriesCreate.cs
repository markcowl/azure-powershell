namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Registry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistry_SubscriptionIdRegistryNameLocationTagsPropertiesSkuRegistriesCreate(Carbon.Json.JsonObject json)
        {
