namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Webhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for WebhookCreateParameters property</summary>
        private Sample.API.Models.IWebhookCreateParameters _webhookCreateParameters;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters for creating a webhook.")]
        public Sample.API.Models.IWebhookCreateParameters WebhookCreateParameters
        {
            get
            {
                return this._webhookCreateParameters;
            }
            set
            {
                this._webhookCreateParameters = value;
            }
        }
        ...
        public Sample.API.Cmdlets.NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(Carbon.Json.JsonObject json)
        {
            ...
            _webhookCreateParameters = Sample.API.Models.WebhookCreateParameters.FromJson(json.Property("WebhookCreateParameters"));
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.WebhooksCreate(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, WebhookName, WebhookCreateParameters, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IWebhook
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "WebhookCreateParameters", WebhookCreateParameters?.ToJson());
            return result;
        }
    }
}