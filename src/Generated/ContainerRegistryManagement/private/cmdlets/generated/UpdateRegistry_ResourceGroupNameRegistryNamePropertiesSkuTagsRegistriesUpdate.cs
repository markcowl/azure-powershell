namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Registry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateRegistry_ResourceGroupNameRegistryNamePropertiesSkuTagsRegistriesUpdate(Carbon.Json.JsonObject json)
        {
