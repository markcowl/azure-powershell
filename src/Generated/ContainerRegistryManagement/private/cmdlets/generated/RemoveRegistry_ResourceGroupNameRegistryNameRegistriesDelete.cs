namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Registry_ResourceGroupNameRegistryNameRegistriesDelete")]
    public class RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveRegistry_ResourceGroupNameRegistryNameRegistriesDelete(Carbon.Json.JsonObject json)
        {
