namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListResult))]
    public class GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_ResourceGroupResourceGroupNameRegistriesListByResourceGroup(Carbon.Json.JsonObject json)
        {
