namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Registry_RegistryNameRegistriesDelete")]
    public class RemoveRegistry_RegistryNameRegistriesDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveRegistry_RegistryNameRegistriesDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveRegistry_RegistryNameRegistriesDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveRegistry_RegistryNameRegistriesDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveRegistry_RegistryNameRegistriesDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveRegistry_RegistryNameRegistriesDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveRegistry_RegistryNameRegistriesDelete(Carbon.Json.JsonObject json)
        {
