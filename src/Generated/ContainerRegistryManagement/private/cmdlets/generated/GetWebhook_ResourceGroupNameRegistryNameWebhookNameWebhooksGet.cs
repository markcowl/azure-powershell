namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksGet(Carbon.Json.JsonObject json)
        {
