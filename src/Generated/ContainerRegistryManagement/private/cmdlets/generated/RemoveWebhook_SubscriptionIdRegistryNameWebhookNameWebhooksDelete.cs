namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Webhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete")]
    public class RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveWebhook_SubscriptionIdRegistryNameWebhookNameWebhooksDelete(Carbon.Json.JsonObject json)
        {
