namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListResult))]
    public class GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_ResourceGroupSubscriptionIdResourceGroupNameRegistriesListByResourceGroup(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesListByResourceGroup(ApiVersion, SubscriptionId, ResourceGroupName, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IRegistryListResult
