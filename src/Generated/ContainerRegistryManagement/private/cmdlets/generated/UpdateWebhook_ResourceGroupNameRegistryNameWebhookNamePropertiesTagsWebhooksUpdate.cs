namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Webhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateWebhook_ResourceGroupNameRegistryNameWebhookNamePropertiesTagsWebhooksUpdate(Carbon.Json.JsonObject json)
        {
