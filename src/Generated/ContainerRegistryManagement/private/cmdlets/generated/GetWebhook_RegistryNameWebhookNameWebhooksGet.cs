namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_RegistryNameWebhookNameWebhooksGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class GetWebhook_RegistryNameWebhookNameWebhooksGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_RegistryNameWebhookNameWebhooksGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_RegistryNameWebhookNameWebhooksGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_RegistryNameWebhookNameWebhooksGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_RegistryNameWebhookNameWebhooksGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_RegistryNameWebhookNameWebhooksGet()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_RegistryNameWebhookNameWebhooksGet(Carbon.Json.JsonObject json)
        {
