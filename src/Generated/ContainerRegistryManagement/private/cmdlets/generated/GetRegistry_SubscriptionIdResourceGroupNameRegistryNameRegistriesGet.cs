namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesGet(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesGet(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, async(response) => {
