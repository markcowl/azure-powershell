namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_SubscriptionIdRegistryNameRegistriesGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class GetRegistry_SubscriptionIdRegistryNameRegistriesGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_SubscriptionIdRegistryNameRegistriesGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_SubscriptionIdRegistryNameRegistriesGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_SubscriptionIdRegistryNameRegistriesGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_SubscriptionIdRegistryNameRegistriesGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_SubscriptionIdRegistryNameRegistriesGet()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_SubscriptionIdRegistryNameRegistriesGet(Carbon.Json.JsonObject json)
        {
