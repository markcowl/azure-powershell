namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_RegistryNameReplicationNameReplicationsGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class GetReplication_RegistryNameReplicationNameReplicationsGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_RegistryNameReplicationNameReplicationsGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_RegistryNameReplicationNameReplicationsGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_RegistryNameReplicationNameReplicationsGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_RegistryNameReplicationNameReplicationsGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_RegistryNameReplicationNameReplicationsGet()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_RegistryNameReplicationNameReplicationsGet(Carbon.Json.JsonObject json)
        {
