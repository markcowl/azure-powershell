namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Replication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewReplication_ResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate(Carbon.Json.JsonObject json)
        {
