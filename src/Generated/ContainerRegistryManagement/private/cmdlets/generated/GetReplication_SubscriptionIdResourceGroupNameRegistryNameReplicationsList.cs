namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplicationListResult))]
    public class GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationsList(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.ReplicationsList(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IReplicationListResult
