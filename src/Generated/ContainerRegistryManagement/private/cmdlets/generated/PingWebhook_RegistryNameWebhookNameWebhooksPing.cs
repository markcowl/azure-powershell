namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsDiagnostic.Ping, @"Webhook_RegistryNameWebhookNameWebhooksPing")]
    [System.Management.Automation.OutputType(typeof(string))]
    public class PingWebhook_RegistryNameWebhookNameWebhooksPing : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.PingWebhook_RegistryNameWebhookNameWebhooksPing Clone()
        {
        ...
        public static Sample.API.Cmdlets.PingWebhook_RegistryNameWebhookNameWebhooksPing FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new PingWebhook_RegistryNameWebhookNameWebhooksPing(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.PingWebhook_RegistryNameWebhookNameWebhooksPing FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public PingWebhook_RegistryNameWebhookNameWebhooksPing()
        {
        }
        /// <param name="json"> </param>
        internal PingWebhook_RegistryNameWebhookNameWebhooksPing(Carbon.Json.JsonObject json)
        {
