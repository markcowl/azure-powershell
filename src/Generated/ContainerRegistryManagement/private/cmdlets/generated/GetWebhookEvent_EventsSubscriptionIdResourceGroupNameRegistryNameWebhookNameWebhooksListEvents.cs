namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IEventListResult))]
    public class GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookEvent_EventsSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksListEvents(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.WebhooksListEvents(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, WebhookName, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IEventListResult
