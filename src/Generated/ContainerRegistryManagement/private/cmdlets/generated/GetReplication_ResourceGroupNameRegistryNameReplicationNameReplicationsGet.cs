namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsGet(Carbon.Json.JsonObject json)
        {
