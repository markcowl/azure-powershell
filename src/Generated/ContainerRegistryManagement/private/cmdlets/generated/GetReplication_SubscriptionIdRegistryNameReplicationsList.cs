namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_SubscriptionIdRegistryNameReplicationsList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplicationListResult))]
    public class GetReplication_SubscriptionIdRegistryNameReplicationsList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_SubscriptionIdRegistryNameReplicationsList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdRegistryNameReplicationsList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_SubscriptionIdRegistryNameReplicationsList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_SubscriptionIdRegistryNameReplicationsList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_SubscriptionIdRegistryNameReplicationsList()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_SubscriptionIdRegistryNameReplicationsList(Carbon.Json.JsonObject json)
        {
