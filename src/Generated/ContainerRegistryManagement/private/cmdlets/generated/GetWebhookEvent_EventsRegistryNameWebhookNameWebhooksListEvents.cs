namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IEventListResult))]
    public class GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookEvent_EventsRegistryNameWebhookNameWebhooksListEvents(Carbon.Json.JsonObject json)
        {
