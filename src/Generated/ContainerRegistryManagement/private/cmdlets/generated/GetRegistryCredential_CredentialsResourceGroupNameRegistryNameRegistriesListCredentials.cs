namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"RegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistryCredential_CredentialsResourceGroupNameRegistryNameRegistriesListCredentials(Carbon.Json.JsonObject json)
        {
