namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"RegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage")]
    public class ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage Clone()
        {
        ...
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage()
        {
        }
        /// <param name="json"> </param>
        internal ImportRegistryImage_ImageRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(Carbon.Json.JsonObject json)
        {
