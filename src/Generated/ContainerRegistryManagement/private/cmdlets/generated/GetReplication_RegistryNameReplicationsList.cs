namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_RegistryNameReplicationsList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplicationListResult))]
    public class GetReplication_RegistryNameReplicationsList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_RegistryNameReplicationsList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_RegistryNameReplicationsList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_RegistryNameReplicationsList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_RegistryNameReplicationsList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_RegistryNameReplicationsList()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_RegistryNameReplicationsList(Carbon.Json.JsonObject json)
        {
