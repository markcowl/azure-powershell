namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_ResourceGroupNameRegistryNameWebhooksList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhookListResult))]
    public class GetWebhook_ResourceGroupNameRegistryNameWebhooksList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_ResourceGroupNameRegistryNameWebhooksList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_ResourceGroupNameRegistryNameWebhooksList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_ResourceGroupNameRegistryNameWebhooksList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_ResourceGroupNameRegistryNameWebhooksList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_ResourceGroupNameRegistryNameWebhooksList()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_ResourceGroupNameRegistryNameWebhooksList(Carbon.Json.JsonObject json)
        {
