namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Registry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateRegistry_SubscriptionIdRegistryNamePropertiesSkuTagsRegistriesUpdate(Carbon.Json.JsonObject json)
        {
