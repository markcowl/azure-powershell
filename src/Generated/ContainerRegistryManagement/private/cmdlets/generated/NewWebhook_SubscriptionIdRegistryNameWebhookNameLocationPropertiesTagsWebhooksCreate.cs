namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Webhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewWebhook_SubscriptionIdRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(Carbon.Json.JsonObject json)
        {
