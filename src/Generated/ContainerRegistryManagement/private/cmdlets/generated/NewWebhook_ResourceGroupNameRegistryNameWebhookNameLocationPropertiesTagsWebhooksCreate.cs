namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Webhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewWebhook_ResourceGroupNameRegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(Carbon.Json.JsonObject json)
        {
