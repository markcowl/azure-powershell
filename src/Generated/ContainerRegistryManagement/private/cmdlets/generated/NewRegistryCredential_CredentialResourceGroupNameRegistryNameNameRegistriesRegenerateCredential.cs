namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"RegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistryCredential_CredentialResourceGroupNameRegistryNameNameRegistriesRegenerateCredential(Carbon.Json.JsonObject json)
        {
