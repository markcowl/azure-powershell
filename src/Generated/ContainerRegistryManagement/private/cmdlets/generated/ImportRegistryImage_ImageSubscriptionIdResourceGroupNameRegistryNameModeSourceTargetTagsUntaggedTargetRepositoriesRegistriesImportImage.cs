namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Import, @"RegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage")]
    public class ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        private Sample.API.Models.IImportImageParameters _parameters;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "HELP MESSAGE MISSING")]
        public Sample.API.Models.IImportImageParameters Parameters
        {
            get
            {
        ...
        public Sample.API.Cmdlets.ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage Clone()
        {
        ...
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage()
        {
        }
        /// <param name="json"> </param>
        internal ImportRegistryImage_ImageSubscriptionIdResourceGroupNameRegistryNameModeSourceTargetTagsUntaggedTargetRepositoriesRegistriesImportImage(Carbon.Json.JsonObject json)
        {
            ...
            _parameters = Sample.API.Models.ImportImageParameters.FromJson(json.Property("Parameters"));
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesImportImage(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, Parameters, async(response) => {
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "Parameters", Parameters?.ToJson());
            return result;
        }
    }
}