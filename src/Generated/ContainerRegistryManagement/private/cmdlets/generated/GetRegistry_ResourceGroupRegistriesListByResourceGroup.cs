namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Registry_ResourceGroupRegistriesListByResourceGroup")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListResult))]
    public class GetRegistry_ResourceGroupRegistriesListByResourceGroup : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistry_ResourceGroupRegistriesListByResourceGroup Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupRegistriesListByResourceGroup FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistry_ResourceGroupRegistriesListByResourceGroup(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistry_ResourceGroupRegistriesListByResourceGroup FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistry_ResourceGroupRegistriesListByResourceGroup()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistry_ResourceGroupRegistriesListByResourceGroup(Carbon.Json.JsonObject json)
        {
