namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IEventListResult))]
    public class GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookEvent_EventsSubscriptionIdRegistryNameWebhookNameWebhooksListEvents(Carbon.Json.JsonObject json)
        {
