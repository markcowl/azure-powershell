namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ICallbackConfig))]
    public class GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookCallbackConfig_CallbackConfigSubscriptionIdRegistryNameWebhookNameWebhooksGetCallbackConfig(Carbon.Json.JsonObject json)
        {
