namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Replication_ResourceGroupNameRegistryNameReplicationsList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplicationListResult))]
    public class GetReplication_ResourceGroupNameRegistryNameReplicationsList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetReplication_ResourceGroupNameRegistryNameReplicationsList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetReplication_ResourceGroupNameRegistryNameReplicationsList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetReplication_ResourceGroupNameRegistryNameReplicationsList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetReplication_ResourceGroupNameRegistryNameReplicationsList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetReplication_ResourceGroupNameRegistryNameReplicationsList()
        {
        }
        /// <param name="json"> </param>
        internal GetReplication_ResourceGroupNameRegistryNameReplicationsList(Carbon.Json.JsonObject json)
        {
