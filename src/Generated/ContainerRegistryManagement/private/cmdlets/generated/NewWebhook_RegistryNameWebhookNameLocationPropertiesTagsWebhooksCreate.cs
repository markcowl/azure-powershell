namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Webhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewWebhook_RegistryNameWebhookNameLocationPropertiesTagsWebhooksCreate(Carbon.Json.JsonObject json)
        {
