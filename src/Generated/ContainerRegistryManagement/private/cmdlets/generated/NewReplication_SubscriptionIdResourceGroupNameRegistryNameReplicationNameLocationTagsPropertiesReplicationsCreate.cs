namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Replication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameLocationTagsPropertiesReplicationsCreate(Carbon.Json.JsonObject json)
        {
