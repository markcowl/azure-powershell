namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Webhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete")]
    public class RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksDelete(Carbon.Json.JsonObject json)
        {
