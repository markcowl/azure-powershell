namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"RegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryUsage[]))]
    public class GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistryUsage_UsagesResourceGroupNameRegistryNameRegistriesListUsages(Carbon.Json.JsonObject json)
        {
