namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsDiagnostic.Test, @"RegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryNameStatus))]
    public class TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability Clone()
        {
        ...
        public static Sample.API.Cmdlets.TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability()
        {
        }
        /// <param name="json"> </param>
        internal TestRegistryNameAvailability_NameAvailabilityNameTypeRegistriesCheckNameAvailability(Carbon.Json.JsonObject json)
        {
