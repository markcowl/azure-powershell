namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Registry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        /// <summary>Backing field for Registry property</summary>
        private Sample.API.Models.IRegistry _registry;

        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "An object that represents a container registry.")]
        public Sample.API.Models.IRegistry Registry
        {
            get
            {
        ...
        public Sample.API.Cmdlets.NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistry_SubscriptionIdResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate(Carbon.Json.JsonObject json)
        {
            ...
            _registry = Sample.API.Models.Registry.FromJson(json.Property("Registry"));
        }
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesCreate(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, Registry, async(response) => {
        ...
        public Carbon.Json.JsonNode ToJson(Carbon.Json.JsonObject container, Microsoft.Rest.ClientRuntime.JsonMode serializationMode)
        {
            ...
            container.SafeAdd( "Registry", Registry?.ToJson());
            return result;
        }
    }
}