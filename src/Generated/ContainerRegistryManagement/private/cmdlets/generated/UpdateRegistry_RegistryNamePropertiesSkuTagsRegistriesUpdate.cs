namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Registry_RegistryNamePropertiesSkuTagsRegistriesUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateRegistry_RegistryNamePropertiesSkuTagsRegistriesUpdate(Carbon.Json.JsonObject json)
        {
