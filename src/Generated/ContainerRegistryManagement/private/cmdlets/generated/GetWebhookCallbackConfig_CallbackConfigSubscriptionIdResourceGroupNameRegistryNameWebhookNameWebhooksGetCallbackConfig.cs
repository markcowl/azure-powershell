namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.ICallbackConfig))]
    public class GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookCallbackConfig_CallbackConfigSubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksGetCallbackConfig(Carbon.Json.JsonObject json)
        {
