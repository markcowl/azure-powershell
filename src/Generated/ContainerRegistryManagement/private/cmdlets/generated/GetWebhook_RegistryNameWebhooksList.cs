namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Webhook_RegistryNameWebhooksList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhookListResult))]
    public class GetWebhook_RegistryNameWebhooksList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhook_RegistryNameWebhooksList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhook_RegistryNameWebhooksList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhook_RegistryNameWebhooksList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhook_RegistryNameWebhooksList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhook_RegistryNameWebhooksList()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhook_RegistryNameWebhooksList(Carbon.Json.JsonObject json)
        {
