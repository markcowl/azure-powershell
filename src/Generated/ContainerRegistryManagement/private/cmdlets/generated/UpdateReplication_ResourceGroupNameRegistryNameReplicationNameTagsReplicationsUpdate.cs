namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Replication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateReplication_ResourceGroupNameRegistryNameReplicationNameTagsReplicationsUpdate(Carbon.Json.JsonObject json)
        {
