namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Registry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete")]
    public class RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.RegistriesDelete(ApiVersion, SubscriptionId, ResourceGroupName, RegistryName, async(response) => {
        ...
        public RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveRegistry_SubscriptionIdResourceGroupNameRegistryNameRegistriesDelete(Carbon.Json.JsonObject json)
        {
