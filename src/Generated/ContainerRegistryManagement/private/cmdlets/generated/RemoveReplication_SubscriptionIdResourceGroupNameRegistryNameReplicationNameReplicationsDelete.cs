namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Replication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete")]
    public class RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveReplication_SubscriptionIdResourceGroupNameRegistryNameReplicationNameReplicationsDelete(Carbon.Json.JsonObject json)
        {
