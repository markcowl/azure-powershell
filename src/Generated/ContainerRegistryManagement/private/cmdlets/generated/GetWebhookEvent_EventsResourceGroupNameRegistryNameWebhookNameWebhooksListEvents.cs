namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"WebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IEventListResult))]
    public class GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents()
        {
        }
        /// <param name="json"> </param>
        internal GetWebhookEvent_EventsResourceGroupNameRegistryNameWebhookNameWebhooksListEvents(Carbon.Json.JsonObject json)
        {
