namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Webhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateWebhook_SubscriptionIdRegistryNameWebhookNamePropertiesTagsWebhooksUpdate(Carbon.Json.JsonObject json)
        {
