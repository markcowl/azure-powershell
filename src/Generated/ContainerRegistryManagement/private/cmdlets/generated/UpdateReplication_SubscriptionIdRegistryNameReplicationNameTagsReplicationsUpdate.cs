namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Replication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IReplication))]
    public class UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateReplication_SubscriptionIdRegistryNameReplicationNameTagsReplicationsUpdate(Carbon.Json.JsonObject json)
        {
