namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Registry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistry_RegistryNameLocationTagsPropertiesSkuRegistriesCreate(Carbon.Json.JsonObject json)
        {
