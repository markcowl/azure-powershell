namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Registry_SubscriptionIdRegistryNameRegistriesDelete")]
    public class RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveRegistry_SubscriptionIdRegistryNameRegistriesDelete(Carbon.Json.JsonObject json)
        {
