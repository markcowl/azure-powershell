namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"RegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistryListCredentialsResult))]
    public class GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials()
        {
        }
        /// <param name="json"> </param>
        internal GetRegistryCredential_CredentialsSubscriptionIdRegistryNameRegistriesListCredentials(Carbon.Json.JsonObject json)
        {
