namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"Operation_OperationsList")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IOperationListResult))]
    public class GetOperation_OperationsList : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.GetOperation_OperationsList Clone()
        {
        ...
        public static Sample.API.Cmdlets.GetOperation_OperationsList FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new GetOperation_OperationsList(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.GetOperation_OperationsList FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public GetOperation_OperationsList()
        {
        }
        /// <param name="json"> </param>
        internal GetOperation_OperationsList(Carbon.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            ...
            await this.Client.OperationsList(ApiVersion, async(response) => {
                // on200 - response for 200 / application/json
                // (await response.Result) // should be Sample.API.Models.IOperationListResult
