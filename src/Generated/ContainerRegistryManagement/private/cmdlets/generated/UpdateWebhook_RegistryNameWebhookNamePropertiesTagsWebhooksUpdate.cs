namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"Webhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IWebhook))]
    public class UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate Clone()
        {
        ...
        public static Sample.API.Cmdlets.UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate()
        {
        }
        /// <param name="json"> </param>
        internal UpdateWebhook_RegistryNameWebhookNamePropertiesTagsWebhooksUpdate(Carbon.Json.JsonObject json)
        {
