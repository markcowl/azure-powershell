namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsDiagnostic.Ping, @"Webhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing")]
    [System.Management.Automation.OutputType(typeof(string))]
    public class PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing Clone()
        {
        ...
        public static Sample.API.Cmdlets.PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing()
        {
        }
        /// <param name="json"> </param>
        internal PingWebhook_SubscriptionIdResourceGroupNameRegistryNameWebhookNameWebhooksPing(Carbon.Json.JsonObject json)
        {
