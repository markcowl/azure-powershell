namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Remove, @"Replication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete")]
    public class RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete Clone()
        {
        ...
        public static Sample.API.Cmdlets.RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        ...
        public RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete()
        {
        }
        /// <param name="json"> </param>
        internal RemoveReplication_ResourceGroupNameRegistryNameReplicationNameReplicationsDelete(Carbon.Json.JsonObject json)
        {
