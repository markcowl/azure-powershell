namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsDiagnostic.Ping, @"Webhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing")]
    [System.Management.Automation.OutputType(typeof(string))]
    public class PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing Clone()
        {
        ...
        public static Sample.API.Cmdlets.PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing()
        {
        }
        /// <param name="json"> </param>
        internal PingWebhook_ResourceGroupNameRegistryNameWebhookNameWebhooksPing(Carbon.Json.JsonObject json)
        {
