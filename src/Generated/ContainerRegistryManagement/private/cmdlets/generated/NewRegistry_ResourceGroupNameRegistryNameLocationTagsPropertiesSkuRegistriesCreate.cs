namespace Sample.API.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"Registry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate")]
    [System.Management.Automation.OutputType(typeof(Sample.API.Models.IRegistry))]
    public class NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate : System.Management.Automation.PSCmdlet, Microsoft.Rest.ClientRuntime.IEventListener
    {
        ...
        public Sample.API.Cmdlets.NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate Clone()
        {
        ...
        public static Sample.API.Cmdlets.NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate(json) : null;
        }
        /// <param name="jsonText"> </param>
        public static Sample.API.Cmdlets.NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Carbon.Json.JsonObject.Parse(jsonText));
        public NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate()
        {
        }
        /// <param name="json"> </param>
        internal NewRegistry_ResourceGroupNameRegistryNameLocationTagsPropertiesSkuRegistriesCreate(Carbon.Json.JsonObject json)
        {
