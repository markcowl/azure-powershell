namespace Sample.API.Models
{
    ...
    public partial class OperationListResult : Sample.API.Models.IOperationListResult, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.IOperationDefinition[] _value;
        ...
        /// </summary>
        public Sample.API.Models.IOperationDefinition[] Value
        {
            get
            {
                return this._value;
        ...
        internal OperationListResult(Carbon.Json.JsonObject json)
        {
            ...
            json.ArrayProperty("value", ref this._value, __each => Sample.API.Models.OperationDefinition.FromJson(__each) );
            AfterFromJson(json);
        }
    ...
    public partial interface IOperationListResult : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        ...
        Sample.API.Models.IOperationDefinition[] Value { get; set; }
    }
}