namespace Sample.API.Models
{
    ...
    public partial class ReplicationListResult : Sample.API.Models.IReplicationListResult, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        public static Sample.API.Models.IReplicationListResult FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new ReplicationListResult(json) : null;
        }
        /// <param name="json"> </param>
        internal ReplicationListResult(Carbon.Json.JsonObject json)
        {
            ...
            json.ArrayProperty("value", ref this._value, __each => Sample.API.Models.Replication.FromJson(__each) );
            AfterFromJson(json);
        }
    ...
    public partial interface IReplicationListResult : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        string NextLink { get; set; }
        Sample.API.Models.IReplication[] Value { get; set; }
    }
}