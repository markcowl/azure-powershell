namespace Sample.API.Models
{
    ...
    public partial class RegistryListResult : Sample.API.Models.IRegistryListResult, Microsoft.Rest.ClientRuntime.IValidates
    {
        ...
        private Sample.API.Models.IRegistry[] _value;
        ...
        /// </summary>
        public Sample.API.Models.IRegistry[] Value
        {
            get
            {
                return this._value;
        ...
        public static Sample.API.Models.IRegistryListResult FromJson(Carbon.Json.JsonNode node)
        {
            return node is Carbon.Json.JsonObject json ? new RegistryListResult(json) : null;
        }
        /// <param name="json"> </param>
        internal RegistryListResult(Carbon.Json.JsonObject json)
        {
            ...
            json.ArrayProperty("value", ref this._value, __each => Sample.API.Models.Registry.FromJson(__each) );
            AfterFromJson(json);
        }
    ...
    public partial interface IRegistryListResult : Microsoft.Rest.ClientRuntime.IJsonSerializable {
        string NextLink { get; set; }
        Sample.API.Models.IRegistry[] Value { get; set; }
    }
}