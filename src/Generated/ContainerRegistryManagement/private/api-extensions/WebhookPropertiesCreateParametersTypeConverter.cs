namespace Sample.API.Models
{
    ...
    public class WebhookPropertiesCreateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                WebhookPropertiesCreateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                Actions = sourceValue.Actions,
                CustomHeaders = sourceValue.CustomHeaders,
                Scope = sourceValue.Scope,
                ServiceUri = sourceValue.ServiceUri,
