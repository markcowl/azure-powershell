namespace Sample.API.Models
{
    ...
    public class EventRequestMessageTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                EventRequestMessage.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Content = EventContentTypeConverter.ConvertFrom(sourceValue.Content),
                Headers = sourceValue.Headers,
                RequestUri = sourceValue.RequestUri,
