namespace Sample.API.Models
{
    ...
    public class ImportSourceTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ImportSource.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                ResourceId = sourceValue.ResourceId,
                SourceImage = sourceValue.SourceImage,
                };
            }
            catch
            {
