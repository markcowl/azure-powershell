namespace Sample.API.Models
{
    ...
    public class EventContentTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                EventContent.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Actor = ActorTypeConverter.ConvertFrom(sourceValue.Actor),
                Id = sourceValue.Id,
                Request = RequestTypeConverter.ConvertFrom(sourceValue.Request),
                Source = SourceTypeConverter.ConvertFrom(sourceValue.Source),
                Target = TargetTypeConverter.ConvertFrom(sourceValue.Target),
