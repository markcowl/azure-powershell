namespace Sample.API.Models
{
    ...
    public class EventTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Event.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new Event
                {
                EventRequestMessage = EventRequestMessageTypeConverter.ConvertFrom(sourceValue.EventRequestMessage),
                EventResponseMessage = EventResponseMessageTypeConverter.ConvertFrom(sourceValue.EventResponseMessage),
                };
            }
            catch
            {
