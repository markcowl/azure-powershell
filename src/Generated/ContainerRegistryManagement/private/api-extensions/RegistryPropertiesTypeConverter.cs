namespace Sample.API.Models
{
    ...
    public class RegistryPropertiesTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RegistryProperties.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                AdminUserEnabled = sourceValue.AdminUserEnabled,
                CreationDate = sourceValue.CreationDate,
                LoginServer = sourceValue.LoginServer,
                ProvisioningState = sourceValue.ProvisioningState,
                Status = StatusTypeConverter.ConvertFrom(sourceValue.Status),
                StorageAccount = StorageAccountPropertiesTypeConverter.ConvertFrom(sourceValue.StorageAccount),
                };
            }
            catch
            {
