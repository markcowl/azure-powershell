namespace Sample.API.Models
{
    ...
    public class WebhookUpdateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                WebhookUpdateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new WebhookUpdateParameters
                {
                Properties = WebhookPropertiesUpdateParametersTypeConverter.ConvertFrom(sourceValue.Properties),
