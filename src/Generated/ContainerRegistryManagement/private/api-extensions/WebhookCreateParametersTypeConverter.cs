namespace Sample.API.Models
{
    ...
    public class WebhookCreateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                WebhookCreateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new WebhookCreateParameters
                {
                Location = sourceValue.Location,
                Properties = WebhookPropertiesCreateParametersTypeConverter.ConvertFrom(sourceValue.Properties),
