namespace Sample.API.Models
{
    ...
    public class RegistryUpdateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RegistryUpdateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RegistryUpdateParameters
                {
                Properties = RegistryPropertiesUpdateParametersTypeConverter.ConvertFrom(sourceValue.Properties),
                Sku = SkuTypeConverter.ConvertFrom(sourceValue.Sku),
                Tags = sourceValue.Tags,
                };
            }
            catch
            {
