namespace Sample.API.Models
{
    ...
    public class RegistryUsageTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                RegistryUsage.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new RegistryUsage
                {
                Name = sourceValue.Name,
                CurrentValue = sourceValue.CurrentValue,
