namespace Sample.API.Models
{
    ...
    public class RegistryTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Registry.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new Registry
                {
                Properties = RegistryPropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
