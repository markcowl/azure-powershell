namespace Sample.API.Models
{
    ...
    public class RequestTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Request.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Addr = sourceValue.Addr,
                Host = sourceValue.Host,
                Id = sourceValue.Id,
                Useragent = sourceValue.Useragent,
                };
            }
            catch
            {
