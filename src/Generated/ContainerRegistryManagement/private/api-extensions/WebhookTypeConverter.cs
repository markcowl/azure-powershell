namespace Sample.API.Models
{
    ...
    public class WebhookTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Webhook.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new Webhook
                {
                Properties = WebhookPropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                };
            }
            catch
            {
