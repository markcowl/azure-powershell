namespace Sample.API.Models
{
    ...
    public class ImportImageParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ImportImageParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                Source = ImportSourceTypeConverter.ConvertFrom(sourceValue.Source),
                TargetTags = sourceValue.TargetTags,
                UntaggedTargetRepositories = sourceValue.UntaggedTargetRepositories,
                };
            }
            catch
            {
