namespace Sample.API.Models
{
    ...
    public class ReplicationTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                Replication.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                ...
                {
                Properties = ReplicationPropertiesTypeConverter.ConvertFrom(sourceValue.Properties),
                };
            }
            catch
            {
